    ...
    <Layout>
      <div className="page">
        ...
        <div className="flex-container">
            ...
            <p className="main-text">I believe I'm one of the most versatile individuals that exists, and it has been been a personal goal of mine to be so; ultimatley, use every skill possible to save our planet</p> 
        </div>
        <div className="flex-container">
